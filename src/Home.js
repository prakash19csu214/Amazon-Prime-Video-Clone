  ...
  return (
    ...
    <div className="container">
      <div className="navbar">
        ...
        <a href="#news"><i className="fa fa-globe g" aria-hidden="true" /></a>
      ...
      <p className="t">Join Prime to watch the latest movies, TV shows<br /> and award-winning Amazon Originals</p>
    ...
    <div className="w">
      ...
      <div className="w1">
        ...
        <button className="button button2" style={{marginLeft: '10px'}}>Get started</button>
      </div>
    </div>
    <div className="y">
    ...
    <div className="z">
      ...
      <div className="z1">
        ...
        <button className="button button2" style={{marginLeft: '740px'}}>Get started</button><br />
      </div>
    </div>
    <div className="r">
      ...
      <div>
        ...
        <div className="z1">
          ...
          <button className="button button2" style={{marginLeft: '140px'}}>Get started</button><br />
        </div>
      </div>
      <div className="gr">
        <img src="../public/primelogo.png" className="p1" />
        <a href="#" style={{color: 'rgb(39, 182, 201)', marginLeft: '-300px'}}>Terms and Privacy Notice &nbsp; &nbsp; &nbsp; &nbsp; Send us feedback &nbsp; &nbsp; &nbsp; Help </a>
        <p style={{color: '#fff', marginLeft: '490px', marginTop: '20px'}}>© 1996-2020, Amazon.com, Inc. or its affiliates</p>
      </div>
    </div>
